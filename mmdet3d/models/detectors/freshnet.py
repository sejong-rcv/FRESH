...
class FRESHFFDetector(Base3DDetector):
    r"""FRESHNet Detector
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 pretrained=None):
        super(FRESHFFDetector, self).__init__(init_cfg)
        ...
        ##
        self.conv_64_2 = nn.Sequential(
            ME.MinkowskiConvolution(256, 64, kernel_size=1, dimension=3),
            ME.MinkowskiBatchNorm(64),
            ME.MinkowskiReLU(inplace=True)
        )
        self.conv_128_3 = nn.Sequential(
            ME.MinkowskiConvolution(256, 128, kernel_size=1, dimension=3),
            ME.MinkowskiBatchNorm(128),
            ME.MinkowskiReLU(inplace=True)
        )
        self.conv_128_4 = nn.Sequential(
            ME.MinkowskiConvolution(256, 128, kernel_size=1, dimension=3),
            ME.MinkowskiBatchNorm(128),
            ME.MinkowskiReLU(inplace=True)
        )
    ...
    def _f3(self, x, img_features, img_metas, img_shape):
        ...
        projected_features = self.conv_128_3(projected_features) 
    ...
    def extract_feats(self, points, img, img_metas):
        ...
        x = self.backbone(x)
        x = self.neck(x,
                      partial(self._f3, img_features=img_features, img_metas=img_metas, img_shape=img.shape))
        return x
